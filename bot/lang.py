...
STRINGS = {
    "zh": {
        ...
        "need_code_btn": "请点击获取验证码按钮。",
        "getcode_hint": "👇 点上方按钮或下方按钮获取验证码",        "conn_retry": "连接失败，正在重试...",
        "code_sent": "✅ 验证码已发送\n\n请点击下方按钮查看验证码：",
    ...
    "en": {
        ...
        "getcode_hint": "👇 Tap the button above or below to get the code",
    ...
    "ko": {
        ...
        "getcode_hint": "👇 위 또는 아래 버튼을 눌러 인증코드를 받으세요",
